...
#
# Generated by export_simulation on Sun Apr 17 18:12:39 +0530 2022
#
################################################################################
...
'-reset_run' switch to the './FinalTOP.sh' script.

./FinalTOP.sh -reset_run
...
./FinalTOP.sh -noclean_files

For more information on the script, please type './FinalTOP.sh -help'.
